...
""" PART 1: CODE COMPLETIONS ==================================================
    ...
    for what you're going to type next. In order to use completions, open your
    editor settings, click on "Completion and linting", and make sure the
    "Enable code completion" checkbox is checked.
    ...
    To get the most out of your completions experience, we also recommend
    changing the following settings under the "Completion" tab:

    Show automatic completions after characters entered: 1
    Show automatic completions after keyboard idle (ms): 50
    Time to wait for completions to return (ms): 200

    NOTE: The rest of the tutorial assumes you have made the changes above!
"""
